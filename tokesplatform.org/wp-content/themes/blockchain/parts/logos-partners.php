<div class="logos logos-partners">
    <div class="container">
        <div class="section-header section-header--center before-animation">
            <h3 class="heading heading--xs heading--fw400">In Partnership with</h3>
        </div>
        <div class="logos__list">
            <?php foreach(get_post_items(8) as $postItem) : $thumbnail = get_the_post_thumbnail_url($postItem, 'full'); ?>
